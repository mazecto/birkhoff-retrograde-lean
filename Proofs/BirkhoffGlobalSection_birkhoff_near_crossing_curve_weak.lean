...
import Theorems.Thm_BirkhoffGlobalSection_birkhoff_near_arc_end_weak
...
theorem solution (μ c : ℝ)
  ...
  obtain ⟨α, hα1, hα2, hlimb⟩ := birkhoff_near_arc_end_weak μ c hμ0 hμ1 hc φ hφ b hb hgood hbadb
