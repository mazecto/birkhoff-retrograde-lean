...
import Theorems.Thm_BirkhoffGlobalSection_birkhoff_near_crossing_curve_weak
...
theorem solution (μ c : ℝ)
  ...
  obtain ⟨b, hb, α, hα1, hα2, S, T, hFc, hL, hR, hreal⟩ :=
    birkhoff_near_crossing_curve_weak μ c hμ0 hμ1 hc φ hφ
  ...
  · intro l hl
    ...
    · subst h; simp only [neg_neg, hΓ0p]; refine ⟨hα1, by linarith [Real.sqrt_nonneg 2], le_refl _, zero_le_one⟩
